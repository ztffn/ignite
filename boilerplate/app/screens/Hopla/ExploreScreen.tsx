  ...
  return (
    <Screen preset="scroll" contentContainerStyle={{ padding: 20 }}>
      <View style={[$topContainerInsets, { marginBottom: 30 }]}>
        ...
        <Text style={{ fontSize: 16, color: "#666" }}>Discover amazing places and experiences</Text>
      </View>
        ...
        <Card style={{ marginBottom: 20 }}>
          <View style={{ padding: 20, alignItems: "center" }}>
            ...
            <TouchableOpacity style={{ padding: 15, backgroundColor: "#007AFF", borderRadius: 8 }}>
              <Text style={{ color: "white", fontWeight: "600" }}>Select a Trip</Text>
            </TouchableOpacity>
          </View>
        </Card>
      ) : (
              ...
              <TouchableOpacity key={index} style={{ marginBottom: 15 }}>
                <Card style={{ padding: 20 }}>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ fontSize: 32, marginRight: 15 }}>{category.icon}</Text>
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 16, fontWeight: "600", marginBottom: 5 }}>
                        {category.name}
                      </Text>
                      <Text style={{ fontSize: 14, color: "#666" }}>{category.description}</Text>
                    </View>
