    ...
    <Screen preset="scroll" contentContainerStyle={{ padding: 20 }}>
      ...
      >
        <View>
          ...
          <Text style={{ fontSize: 16, color: "#666" }}>Your AI-powered travel companion</Text>
        </View>
      ...
      <Card style={{ marginBottom: 20 }}>
        <View style={{ padding: 20 }}>
          ...
          {isAuthenticated ? (
            ...
            <Text style={{ fontSize: 16 }}>Sign in to start planning your next adventure</Text>
          )}
        </View>
      </Card>
      ...
      <Card style={{ marginBottom: 20 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 18, fontWeight: "bold", marginBottom: 15 }}>Quick Actions</Text>
          <View style={{ gap: 10 }}>
            ...
            <TouchableOpacity style={{ padding: 15, backgroundColor: "#f0f0f0", borderRadius: 8 }}>
              <Text style={{ textAlign: "center", fontWeight: "600" }}>Explore Destinations</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Card>
      ...
      <Card style={{ marginBottom: 20 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 20, fontWeight: "bold", marginBottom: 15 }}>Current Trip</Text>
          ...
          <Text style={{ fontSize: 14, color: "#666" }}>
            Use the tabs below to manage your itinerary, view the map, explore local attractions,
