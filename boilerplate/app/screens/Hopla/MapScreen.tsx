  ...
  return (
    <Screen preset="scroll" contentContainerStyle={{ padding: 20 }}>
      <View style={[$topContainerInsets, { marginBottom: 30 }]}>
        <Text style={{ fontSize: 28, fontWeight: "bold", marginBottom: 10 }}>Map</Text>
        <Text style={{ fontSize: 16, color: "#666" }}>{selectedTrip.title}</Text>
      </View>
      ...
      <Card style={{ marginBottom: 20 }}>
        <View style={{ padding: 20 }}>
          ...
          {currentCity ? (
            ...
            <Text style={{ fontSize: 16, color: "#666" }}>No city selected</Text>
          )}
        </View>
      </Card>
      ...
      <Card style={{ marginBottom: 20 }}>
        <View style={{ padding: 20 }}>
          <Text style={{ fontSize: 18, fontWeight: "bold", marginBottom: 15 }}>Trip Cities</Text>
